...
_REDDIT_API_SLEEP_TIME = 30 # 30 minutes 
...
def set_background(local_filename):
	...
	os.system("DISPLAY=:0 gsettings set org.gnome.desktop.background picture-uri file:///home/danielmxli/mintpaper/" + escaped_filename)
...
def scrape_and_set(targetSubreddit='spaceporn'):
